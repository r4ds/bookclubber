...
#'
#' @param ... character vectors, specifying subdirectory and file(s) within your
#'   package. The default, none, returns the root of the app.
#'
#' @keywords internal
.app_sys <- function(...) {
  system.file(..., package = "bookclubber")
}
